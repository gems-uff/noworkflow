...
class TrialLW(BaseLW):
    ...
    __slots__, attributes = define_attrs(
        ...
        "path","status","modules_inherited_from_trial_id","parent_id","main_id"]
    )
    nullable = set()
    model = Trial

    def __init__(self, id_, script, start, finish, command,path,status,modules_inherited_from_trial_id,parent_id,main_id):
