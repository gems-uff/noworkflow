...
class HistoryWidget extends Widget {
  ...
  functionDiffWindow(functionDiffJson : any, windowIdAndTitle:string, parentDock : NowVisPanel){   
    ...
    function writeHTMLDiffVariables(spanVariables: d3_Selection<HTMLSpanElement, unknown, null, undefined>, trial1VariablesThatChanged: any[], trial2VariablesAdded: any[], trial1VariablesRemoved : any[]) {
      ...
      if(trial1VariablesThatChanged.length > 0){
        ...
        let spanVariablesChanged = spanVariables.append("spand").attr("id", "diff-function-variables-changed-span");
        addHideShowButton(variablesChangedTitle, "hide-and-show-button-variables-changed", "diff-function-variables-changed-span");
      ...
      if (trial2VariablesAdded.length > 0) {
        ...
        let spanVariablesAdded = spanVariables.append("spand").attr("id", "diff-function-variables-added-span");
        addHideShowButton(variablesAddedTitle, "hide-and-show-button-variables-added", "diff-function-variables-added-span");
      ...
      if (trial1VariablesRemoved.length > 0) {
        ...
        let spanVariablesRemoved = spanVariables.append("spand").attr("id", "diff-function-variables-removed-span");
        addHideShowButton(variablesRemovedTitle, "hide-and-show-button-removed-added", "diff-function-variables-removed-span");
    ...
    ["output", "arguments", "duration", "variables"].forEach((property)=>{
      ...
      if(changeText.includes("changed")){
        ...
        let spanProperty = functionDiffWindow.append("span").attr("id", "diff-function-"+property+"-span");

        if(property != "variables") addHideShowButton(textChangeTitle, "hide-and-show-button-"+property, "diff-function-"+property+"-span");
    ...
    let spanFileAccessAdded = functionDiffWindow.append("span").attr("id", "diff-function-file-access-added-span");
    addHideShowButton(fileAccessAddedTitle, "hide-and-show-button-file-access-added", "diff-function-file-access-added-span");
    ...
    let spanFileAccessRemoved = functionDiffWindow.append("span").attr("id", "diff-function-file-access-removed-span");
    addHideShowButton(fileAccessRemovedTitle, "hide-and-show-button-file-access-removed", "diff-function-file-access-removed-span");
    ...
    let spanFileAccessReplaced = functionDiffWindow.append("span").attr("id", "diff-function-file-access-replaced-span");
    addHideShowButton(fileAccessReplacedTitle, "hide-and-show-button-file-access-replaced", "diff-function-file-access-replaced-span");
